            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-12">
                    ...
                    <div class="error-container mx-auto text-center">
                        <img src="{{asset('assets/img/sidof-home.jpg')}}" alt="">
                        <h2>Sistem Informasi Order Produksi Furniture</h2>
                        <p>digunakan untuk mengolah data, memberikan informasi dan laporan data order produksi furniture</p>
                        @if (Route::has('login'))
                        <div class="top-right links">
                            @auth
                                <a type="button" class="btn btn-success" href="{{ url('/dashboard') }}">Dashboard</a>
                            @else
